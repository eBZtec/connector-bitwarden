...
public class MemberProcessing extends ObjectProcessing {
    ...
    public ObjectClassInfo schema() {
        ...
        objectClassInfoBuilder.setType(MemberProcessing.OBJECT_CLASS_NAME);
        ...
        objectClassInfoBuilder.addAttributeInfo(
                buildAttributeInfo(
                        MemberSchemaAttributes.TWO_FACTOR_ENABLED,
                        Boolean.class,
                        null
                )
        );
        ...
        objectClassInfoBuilder.addAttributeInfo(
                buildAttributeInfo(
                        MemberSchemaAttributes.RESET_PASSWORD_ENROLLED,
                        Boolean.class,
                        null
                )
        );
        objectClassInfoBuilder.addAttributeInfo(
                buildAttributeInfo(
                        MemberSchemaAttributes.SSO_EXTERNAL_ID,
                        String.class,
                        null
                )
        );
        ...
        objectClassInfoBuilder.addAttributeInfo(
                buildAttributeInfo(
                        MemberSchemaAttributes.EXTERNAL_ID,
                        String.class,
                        null
                )
        );
        ...
        objectClassInfoBuilder.addAttributeInfo(
                buildAttributeInfo(
                        MemberSchemaAttributes.PERMISSIONS_ACCESS_EVENTS_LOGS,
                        Boolean.class,
                        null,
                        AttributeInfo.Flags.NOT_UPDATEABLE,
        ...
        objectClassInfoBuilder.addAttributeInfo(
                buildAttributeInfo(
                        MemberSchemaAttributes.PERMISSIONS_ACCESS_IMPORT_EXPORT,
                        Boolean.class,
                        null,
                        AttributeInfo.Flags.NOT_UPDATEABLE,
                        AttributeInfo.Flags.NOT_CREATABLE
        ...
        objectClassInfoBuilder.addAttributeInfo(
                buildAttributeInfo(
                        MemberSchemaAttributes.PERMISSIONS_ACCESS_REPORTS,
                        Boolean.class,
                        null,
                        AttributeInfo.Flags.NOT_UPDATEABLE,
                        AttributeInfo.Flags.NOT_CREATABLE
        ...
        objectClassInfoBuilder.addAttributeInfo(
                buildAttributeInfo(
                        MemberSchemaAttributes.PERMISSIONS_CREATE_NEW_COLLECTIONS,
                        Boolean.class,
                        null,
                        AttributeInfo.Flags.NOT_UPDATEABLE,
                        AttributeInfo.Flags.NOT_CREATABLE
        ...
        objectClassInfoBuilder.addAttributeInfo(
                buildAttributeInfo(
                        MemberSchemaAttributes.PERMISSIONS_EDIT_ANY_COLLECTION,
                        Boolean.class,
                        null,
                        AttributeInfo.Flags.NOT_UPDATEABLE,
                        AttributeInfo.Flags.NOT_CREATABLE
        ...
        objectClassInfoBuilder.addAttributeInfo(
                buildAttributeInfo(
                        MemberSchemaAttributes.PERMISSIONS_DELETE_ANY_COLLECTION,
                        Boolean.class,
                        null,
                        AttributeInfo.Flags.NOT_UPDATEABLE,
                        AttributeInfo.Flags.NOT_CREATABLE
        ...
        objectClassInfoBuilder.addAttributeInfo(
                buildAttributeInfo(
                        MemberSchemaAttributes.PERMISSIONS_MANAGE_GROUPS,
                        Boolean.class,
                        null,
                        AttributeInfo.Flags.NOT_UPDATEABLE,
                        AttributeInfo.Flags.NOT_CREATABLE
        ...
        objectClassInfoBuilder.addAttributeInfo(
                buildAttributeInfo(
                        MemberSchemaAttributes.PERMISSIONS_MANAGE_POLICIES,
                        Boolean.class,
                        null,
                        AttributeInfo.Flags.NOT_UPDATEABLE,
                        AttributeInfo.Flags.NOT_CREATABLE
        ...
        objectClassInfoBuilder.addAttributeInfo(
                buildAttributeInfo(
                        MemberSchemaAttributes.PERMISSIONS_MANAGE_SSO,
                        Boolean.class,
                        null,
                        AttributeInfo.Flags.NOT_UPDATEABLE,
                        AttributeInfo.Flags.NOT_CREATABLE
        ...
        objectClassInfoBuilder.addAttributeInfo(
                buildAttributeInfo(
                        MemberSchemaAttributes.PERMISSIONS_MANAGE_USERS,
                        Boolean.class,
                        null,
                        AttributeInfo.Flags.NOT_UPDATEABLE,
                        AttributeInfo.Flags.NOT_CREATABLE
        ...
        objectClassInfoBuilder.addAttributeInfo(
                buildAttributeInfo(
                        MemberSchemaAttributes.PERMISSIONS_MANAGE_RESET_PASSWORD,
                        Boolean.class,
                        null,
                        AttributeInfo.Flags.NOT_UPDATEABLE,
                        AttributeInfo.Flags.NOT_CREATABLE
        ...
        objectClassInfoBuilder.addAttributeInfo(
                buildAttributeInfo(
                        MemberSchemaAttributes.PERMISSIONS_MANAGE_SCIM,
                        Boolean.class,
                        null,
                        AttributeInfo.Flags.NOT_UPDATEABLE,
                        AttributeInfo.Flags.NOT_CREATABLE
